...
import { ETHER_ADDRESS, GREEN, RED, tokens, ether } from "../helper"
...
export const filledOrdersSelector = createSelector(
    ...
    (orders) => {
      ...
      // Decorate the orders
      orders = decroateFilledOrders(orders);
...
// Decorate Orders 
const decroateFilledOrders = (orders) => {
    ...
    return(
         orders.map((order) => {
           ...
           order = decroateFilledOrder(order, previousOrder)
           // Update the previous order once its decorated
           previousOrder = order
           return order;
         })
    )
...
const decroateFilledOrder = (order, previousOrder) => {
  return {
    ...order,
...
const tokenPriceClass = (tokenPrice, orderId, previousOrder) => {
    ...
    if(previousOrder.tokenPrice <= tokenPrice) {
        // Show GREEN if price higher than  previous order
        return GREEN
    } else {
        // Show RED if price lower than  previous order
        return RED
    }
}
...
export const myOpenOrdersLoadedSelector = createSelector(
  ...
  export const priceChartSelector = createSelector(
      ...
      (orders) => {
        ...
        // Get last 2 orders  for final price and price chanege
    ...
    const buildGraphData = (orders) => {
      ...
      const graphData = hours.map((hour) => {
        ...
        // Calculate price values - open, high, low, close, close
